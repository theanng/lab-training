...
class Kmeans:
    ...
    def load_data(self, data_path):
        def sparse_to_dense(sparse_r_d, vocab_size):
            ...
            indicates_tfidfs = sparse_r_d.split()
            for index_tfidf in indicates_tfidfs:
    ...
    def update_centroid_of(self, cluster):
        member_r_ds = [member._rd for member in cluster._members]
    ...
    def run(self, seed_value, criterion, threshold):
        ...
        #update cluster till convergence
        self._iteration = 0
        while True:
            #reset clusters, retain centroids
            for cluster in self._clusters:
...
Kmeans_5 = Kmeans(5)
Kmeans_5.load_data('data-tf-idf.txt')
Kmeans_5.run(1, 'max_iters', 10)
print(Kmeans_5._clusters)